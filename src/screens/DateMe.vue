    ...
    <nb-content>
      <nb-list>
        <nb-list-item
          ...
          :key="listItem.route"
          button
          :on-press="() => this.props.navigation.navigate(listItem.route)">
          <nb-left>
            <nb-text>
              {{ listItem.text }}
            </nb-text>
